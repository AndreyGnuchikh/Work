...
public class R_WatchReceipts_Test18 extends testedo {
    ...
    void D_AllReceiptAndDataSchF_Test4() {
        try {
            ...
            CheckName("#file-operator-sc", "оно ?");
            CheckName("#file-operator-snc", "хооо ?");
            CheckName("#file-operator-bi", "оня ?");
            CheckName("#file-operator-bnic", "хня ?");
            CheckName("#file-operator-bni", "хоо ?");
            CheckName("#file-operator-bc", "онх ?");
            CheckName("#file-operator-bnc", "хнх ?");
    ...
    void E_AllReceiptAndDataSchFDOP_Test5() {
        try {
            ...
            EnterAndExit.startEndingCertAndSendingFiles(driver);
            Thread.sleep(20000);
            Cabinet.OpenNameFolder("сод 123", driver);
