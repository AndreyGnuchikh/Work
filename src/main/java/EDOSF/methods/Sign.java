...
public class Sign {
    ...
    public static void SignFirstFileUDP(String row, WebDriver driver) throws Exception {
        System.out.println("-----Start method " + Thread.currentThread().getStackTrace()[1].getMethodName());
        Actions builder = new Actions(driver);
        Thread.sleep(3000);
    ...
    public static void SignFirstFileUDPSecondSign(String row, WebDriver driver) throws Exception {
        System.out.println("-----Start method " + Thread.currentThread().getStackTrace()[1].getMethodName());
        Actions builder = new Actions(driver);
        Thread.sleep(3000);
        driver.findElement(By.cssSelector("#grid-basic2-header > tr:nth-child(1) > th:nth-child(1) > div:nth-child(1) > input:nth-child(1)")).click();
