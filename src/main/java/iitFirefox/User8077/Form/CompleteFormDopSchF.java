...
/*        driver.findElement(By.cssSelector("#acceptanceCert-block > div:nth-child(2) > div:nth-child(8) > div > div.col-md-10.col-sm-10 > span > span.selection > span")).click();
   ...
   */     //Seller
        ...
        driver.findElement(By.cssSelector("#recvInfo_representative > div:nth-child(4) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Отчество");
        ...
        driver.findElement(By.cssSelector("#recvInfo_representative > div:nth-child(6) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Иные сведения");
        driver.findElement(By.cssSelector("#recvInfo_representative > div:nth-child(7) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Основание полномочий");
        driver.findElement(By.cssSelector("#shipment-info")).sendKeys("Сведения об отгрузке");
        driver.findElement(By.cssSelector("#shipment-type")).sendKeys("Вид операции");
        driver.findElement(By.cssSelector("#shipment-date")).click();
        driver.findElement(By.cssSelector("#shipment-date_root > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)")).click();
...
/*        driver.findElement(By.cssSelector("#acceptanceCert-block > div:nth-child(2) > div:nth-child(8) > div > div.col-md-10.col-sm-10 > span > span.selection > span")).click();
        ...
        driver.findElement(By.cssSelector(".inputFormat-docConnectDescriptions-group-optional")).sendKeys("Описание");*/
            ...
            driver.findElement(By.cssSelector("#recvInfo_individual > div:nth-child(4) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Отчество");
            driver.findElement(By.cssSelector("#recvInfo_individual > div:nth-child(5) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Иные сведения");
            driver.findElement(By.cssSelector("#recvInfo_individual > div:nth-child(6) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Основание полномочий");
            driver.findElement(By.cssSelector("#shipment-info")).sendKeys("Сведения об отгрузке");
            driver.findElement(By.cssSelector("#shipment-type")).sendKeys("Вид операции");
            driver.findElement(By.cssSelector("#shipment-date")).click();
            driver.findElement(By.cssSelector("#shipment-date_root > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)")).click();
