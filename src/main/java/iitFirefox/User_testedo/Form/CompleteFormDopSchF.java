package iitFirefox.User_testedo.Form;
...
public class CompleteFormDopSchF {
    ...
    public static String DopSchF(WebDriver driver) {
        ...
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)")).click();
        //GoodsSender
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(3) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1)")).click();
        //Buyer
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(3) > div:nth-child(4) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)")).click();
        ...
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(3) > div:nth-child(4) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)")).click();
        //GoodsRecipient
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(3) > div:nth-child(5) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1)")).click();
        ...
        //add
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(4) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)")).click();
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(4) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Name " + date);
        driver.findElement(By.cssSelector("#interUPDdoc > div > div:nth-child(4) > div:nth-child(4) > div > div > div:nth-child(1) > div > div > div > div:nth-child(2) > div.wide_col.flex-center > div:nth-child(1) > span > span.selection > span")).click();
        ...
        driver.findElement(By.cssSelector("#interUPDdoc > div > div:nth-child(4) > div:nth-child(4) > div > div > div:nth-child(1) > div > div > div > div:nth-child(5) > div.wide_col.flex-center > div:nth-child(1) > span > span.selection > span")).click();
        driver.findElement(By.cssSelector(".select2-search__field")).sendKeys("в");
        ...
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(5) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1)")).click();
    ...
    public static String DopSchF_IP(WebDriver driver) {
        ...
        driver.findElement(By.cssSelector(".select2-search__field")).sendKeys("Гнуч");
        Me.Sleep(500);
    ...
    public static String DopSchF_IP_3Page(WebDriver driver) {
        ...
        driver.findElement(By.cssSelector("#recvInfo_representative > div:nth-child(5) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Должность 2 ");
        driver.findElement(By.cssSelector("#recvInfo_representative > div:nth-child(6) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Иные сведения 2 ");
        driver.findElement(By.cssSelector("#org-name")).sendKeys("Наименование организации 2 ");
        driver.findElement(By.cssSelector("#org-shipment-clearance")).sendKeys("Основание доверия 2 ");
        driver.findElement(By.cssSelector("#org-shipment-clearance-pers")).sendKeys("Основание полномочий 2 ");
        driver.findElement(By.cssSelector("#shipment-info")).sendKeys("Сведения об отгрузке 2 ");
        driver.findElement(By.cssSelector("#shipment-type")).sendKeys("Вид операции 2");
        driver.findElement(By.cssSelector("#shipment-date")).click();
        driver.findElement(By.cssSelector("#shipment-date_root > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)")).click();
        //Связанный документ не заполненно.
        driver.findElement(By.cssSelector("#acceptanceCert-block > div:nth-child(2) > div:nth-child(8) > div > div.col-md-10.col-sm-10 > span > span.selection > span")).click();
    ...
    public static String DopSchF_IP_3Page_bloc3(WebDriver driver) {
        ...
        driver.findElement(By.cssSelector("#recvInfo_individual > div:nth-child(5) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Должность 3");
        driver.findElement(By.cssSelector("#recvInfo_individual > div:nth-child(6) > div:nth-child(2) > input:nth-child(1)")).sendKeys("Иные сведения 3");
        driver.findElement(By.cssSelector("#shipment-info")).sendKeys("Сведения об отгрузке 3");
        driver.findElement(By.cssSelector("#shipment-type")).sendKeys("Вид операции 3");
        driver.findElement(By.cssSelector("#shipment-date")).click();
        driver.findElement(By.cssSelector("#shipment-date_root > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)")).click();
        //Связанный документ не заполненно.
        driver.findElement(By.cssSelector("#acceptanceCert-block > div:nth-child(2) > div:nth-child(8) > div > div.col-md-10.col-sm-10 > span > span.selection > span")).click();
    ...
    public static String DopSchFClick(WebDriver driver) {
        ...
        driver.findElement(By.cssSelector(".select2-search__field")).sendKeys("Бамба Лео");
        Me.Sleep(500);
        driver.findElement(By.cssSelector("#select2-buyer-compname-results > li > option")).click();
        driver.findElement(By.cssSelector("#buyer-compokpo")).sendKeys("1231241251");
        driver.findElement(By.cssSelector("#buyer-rusindex")).sendKeys("140057");
        driver.findElement(By.cssSelector("#buyer-rusreg")).sendKeys("г. Санкт-Петербург");
        driver.findElement(By.cssSelector("#buyer-rusarea")).sendKeys("Петродворцовый район");
        driver.findElement(By.cssSelector("#buyer-ruscity")).sendKeys("г. Санкт-Петербург");
        driver.findElement(By.cssSelector("#buyer-ruslocality")).sendKeys("г. Санкт-Петербург");
        driver.findElement(By.cssSelector("#buyer-russtreet")).sendKeys("Адмиралтейский пр-д");
        driver.findElement(By.cssSelector("#buyer-rushouse")).sendKeys("3");
        driver.findElement(By.cssSelector("#buyer-rusbuild")).sendKeys("4");
        driver.findElement(By.cssSelector("#buyer-rusflat")).sendKeys("2020");
        driver.findElement(By.cssSelector("#interSFdoc > div:nth-child(1) > div:nth-child(3) > div:nth-child(4) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1)")).click();
        //GoodsRecipient
        driver.findElement(By.cssSelector("#interUPDdoc > div:nth-child(1) > div:nth-child(3) > div:nth-child(5) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1)")).click();
        driver.findElement(By.cssSelector("input.col-md-12")).sendKeys("555");
        String test = driver.findElement(By.cssSelector("div.input-group:nth-child(1)")).getAttribute("outerHTML");
