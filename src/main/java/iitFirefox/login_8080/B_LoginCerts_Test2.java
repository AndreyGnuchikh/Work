...
public class B_LoginCerts_Test2 {
    ...
    public void A_ValidDate_Test1() {
        ...
        Me.loggingCerts8080(p8080.fio, driver);
    ...
    public void B_ContragentIsDisconnect_Test2() {
        Me.loggingCerts8080(p8080.fio2, driver);
    ...
    public void C_ContragentIsBlock_Test3() {
        Me.loggingCerts8080(p8080.fio3, driver);
    ...
    @Test
    public void D_UserIsBlock_Test4() {
        Me.loggingCerts8080(p8080.fio4, driver);
    ...
    @Test
    public void E_UserNoCabinet_Test5() {
        Me.loggingCerts8080(p8080.fio5, driver);
        checking = driver.findElement(By.xpath("//*[@id=\"alertText\"]")).getText();
    ...
    public void F_UserNoHaveRole_Test6() {
        Me.loggingCerts8080(p8080.fio6, driver);
        checking = driver.findElement(By.xpath("//*[@id=\"alertText\"]")).getText();
    ...
    public void G_UserNoHaveCabinetTest7() {
        Me.loggingCerts8080(p8080.fio7, driver);
...
//        Me.loggingCerts8080(p8080.fio8, driver);
//        checking = driver.findElement(By.xpath("//*[@id=\"alertText\"]")).getText();
//        System.out.println(checking);
...
//    }
    ...
    public void I_NoConnectUser_Test9() {
        Me.loggingCerts8080(p8080.fio9, driver);
    ...
    public void J_KeyDontInput10() throws InterruptedException, IOException {
        Me.loggingCerts8080(p8080.fio10, driver);
