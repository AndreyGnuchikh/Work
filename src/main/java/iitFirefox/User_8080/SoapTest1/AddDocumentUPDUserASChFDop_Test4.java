package iitFirefox.User_8080.SoapTest1;
...
public class AddDocumentUPDUserASChFDop_Test4 {
    static String DocumentAddResult;

    public static String add() {

        String soapEndpointUrl = p8080.urlsoap8080;
        String soapAction = p8080.urlsoap8080;
