...
public class U_SendDocumentToContragent_Test21 extends iit8077 {
    ...
    void sendAllGood2(){
        ...
        Me.Sleep(100);
        driver.findElement(By.cssSelector("#select2-sn-reciever-user-container")).click();
        Me.Sleep(100);
        driver.findElement(By.xpath("//*[contains(text(), 'УПД Должность 2')][contains(@class, 'select2-results__option')]")).click();
        Me.Sleep(100);
    }
    void sendAllGood1(){
        driver.findElement(By.cssSelector(".selectize-input")).click();
        ...
        driver.findElement(By.cssSelector("#select2-sn-recivercabinet-container")).click();
        Me.Sleep(200);
        driver.findElement(By.xpath("//*[contains(text(), 'Переименованный кабинет')][contains(@class, 'select2-results__option')]")).click();

        Me.Sleep(100);
        driver.findElement(By.cssSelector("#select2-sn-reciever-user-container")).click();
        Me.Sleep(100);
        driver.findElement(By.xpath("//*[contains(text(), 'Иванов Денис')][contains(@class, 'select2-results__option')]")).click();
        Me.Sleep(100);
    }
}
