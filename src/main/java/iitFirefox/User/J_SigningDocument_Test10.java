...
public class J_SigningDocument_Test10 {
    ...
    public void G_NoCerts_Test7() {
        ...
        System.out.println(test2);
        Me.CheckExit("В личном хранилище отсутствует сертификат Тест 5ть (7D00D8180003000365EA). Для подписания документа вставьте ключ в ПК, установите сертификат и обновите страницу.", test2, driver);
