...
public class Email {
    ...
    public static void DeletedCabinetMarkerAndDeletedEmail(String url, String pass5log, String EmailName, String EmailPass, WebDriver driver) throws InterruptedException {
        System.out.println("-----Start method " + Thread.currentThread().getStackTrace()[1].getMethodName());
