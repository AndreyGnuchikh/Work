...
public class D_ChooseRoleAndCabinet_Test4 implements Iit8077 {
    ...
    @Order(1)
    @DisplayName("Вход пользователя с 1 кабинетом и 1 роль User.")
    ...
    @RetryingTest(NUM_FAIL)
    @Order(2)
    @DisplayName("Вход пользователя с 1 кабинетом и 1 ролью Admin.")
    ...
    @RetryingTest(NUM_FAIL)
    @Order(3)
    @DisplayName("Вход пользователя с 1 кабинетом и 1 ролью Support\n")
    ...
    @RetryingTest(NUM_FAIL)
    @Order(4)
    @DisplayName("Вход пользователя с 1 кабинетом и 1 ролью BillingEditor")
    ...
    @RetryingTest(NUM_FAIL)
    @Order(5)
    @DisplayName("Вход пользователя с 1 кабинетом и 2 ролями BillingEditor и Admin")
    void E_WithAB_Test5() {
        try {
    ...
    @RetryingTest(NUM_FAIL)
    @Order(6)
    @DisplayName("Вход пользователя со всеми ролями")
    ...
    @RetryingTest(NUM_FAIL)
    @Order(7)
    @DisplayName("Вход пользователя с 4 кабинетами")
